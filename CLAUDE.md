...
- **Продукт** — Second AI Brain — персональная AI-инфраструктура для руководителя. Четыре части: онтология (какие сущности бывают) → методология (как с ними работать) → scaffold (каркас папок и файлов) → plugin (skills + agents + hooks). Данные у клиента, методология у нас — плагин не хранит данные, это интеллектуальный слой поверх
