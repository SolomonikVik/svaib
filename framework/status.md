...
**Методология** — протокол чтения, decision frames. Meeting analysis pipeline v8 (entity-only рабочая версия, behavioral в разработке). Протестирован на 2 реальных клиентских транскриптах, entity extractor 19/20. Онбординг описан, проверен только на MyProfile.
...
**Skills** — 9 файлов в домене meeting-analysis (1 оркестратор, 3 L1-промпта, 1 L1-процедура, 3 L2-промпта/процедуры, 1 README). Рабочий пайплайн: entity extractor → протокол/Telegram/дельты. Behavioral не подключён. Остальные домены — 0.
