...
Встречи по этому проекту: рабочие сессии команды, синки с заказчиком, ретроспективы по вехам. Кросс-проектные встречи — в `projects/meetings/` (если развёрнут) или в `04_company/meetings/`.
