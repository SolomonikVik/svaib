# meetings/ — встречи уровня 04_company/
...
**Когда сюда.** По правилу наименьшей общей родительской папки ([04_company/README.md](../README.md)). Встреча внутри одного подразделения/направления → `{org_node}/meetings/`, не сюда. Встреча дочерних узлов одной группировки → `{parent}/meetings/`.
