...
- [../skills/skill-graphs/](../skills/skill-graphs/) — Skill Graphs: архитектурный паттерн, на котором построен arscontexta
- [../plugins/!plugins.md](../plugins/!plugins.md) — Плагины Claude Code: формат, в котором arscontexta доставляется
