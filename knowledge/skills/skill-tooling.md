...
**Ценность для нас:** Шаг 4 (Build) в todo-skill.md содержит 13-item чеклист — agnix автоматизирует большинство этих проверок. Можно встроить в CI или pre-commit hook.
...
**Философия:** Top-down (наш todo-skill.md) — от боли к скиллу. Bottom-up (Claudeception) — от открытия к скиллу. Оба подхода дополняют друг друга: top-down для запланированных скиллов, bottom-up для emergent patterns.
