...
**Ценность для нас:** наш приёмочный чеклист скилла — ручной; agnix автоматизирует большинство его статических проверок. Можно встроить в CI или pre-commit hook.
...
**Философия:** Top-down (наш процесс создания скиллов) — от боли к скиллу. Bottom-up (Claudeception) — от открытия к скиллу. Оба подхода дополняют друг друга: top-down для запланированных скиллов, bottom-up для emergent patterns.
