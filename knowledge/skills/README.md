...
- [rule-enforcement.md](rule-enforcement.md) — Класс правила (регламент / культура / процесс) и enforcement: воронка, три критерия завершённости, подкласс «будильник», ловушки проектирования проверок
