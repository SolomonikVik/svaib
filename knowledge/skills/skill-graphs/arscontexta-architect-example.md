...
> Полный текст самого сложного скилла arscontexta v0.8.0. Демонстрирует все 7 паттернов из [arscontexta-skill-anatomy.md](arscontexta-skill-anatomy.md): EXECUTE NOW, фазовая архитектура (7 фаз), edge cases, quality gates, runtime config, articulation test, vocabulary templating. Используется как reference при проектировании сложных скиллов.

## Скилл /architect — полный текст SKILL.md
---
name: architect
...
- [arscontexta-skill-anatomy.md](arscontexta-skill-anatomy.md) — 7 паттернов, извлечённых из этого и других скиллов
- [skill-graphs.md](skill-graphs.md) — теория: что такое skill graph и зачем
- [architecture.md](architecture.md) — архитектура skill graph (Three-Space, MOC, Hooks, Pipeline)
