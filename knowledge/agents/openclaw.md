...
**Ограничения:** Нет долгосрочной структурированной памяти, knowledge graph или темпоральности. Персистентность на уровне сессий, не на уровне знаний. Memory — самый слабый компонент архитектуры. О подходах к темпоральной памяти (Graphiti, Hindsight) см. [../context/temporal-graphs.md](../context/temporal-graphs.md).
...
- [mcp.md](mcp.md) — MCP как протокол интеграции (OpenClaw использует MCP)
- [subagents.md](subagents.md) — субагентные паттерны (supervisor-specialist из OpenClaw)
- [!agents.md](!agents.md) — сводка по агентным системам
