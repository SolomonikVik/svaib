...
**Гранулярность:** Один файл = одна категория инструментов (презентации, транскрибация, скрапинг), не один инструмент. Отдельный файл на инструмент — только если он ключевой для нашей работы и материала больше, чем на всю категорию (пример: cowork.md, openclaw.md).
