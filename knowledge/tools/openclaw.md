...
**Для SVAIB:** OpenClaw подтверждает жизнеспособность архитектуры Skills + Memory на Markdown + Gateway к мессенджерам. Наш product/plugin/skills/scaffold/template/ — по сути та же идея, но со структурированной онтологией вместо плоского memory.md.
...
- [paperclip.md](paperclip.md) — Paperclip: оркестратор-«компания» уровнем выше; фрейм «OpenClaw — сотрудник, Paperclip — компания»
