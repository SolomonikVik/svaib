...
У нас слой вывода уже частично реализован — фирменные спеки HTML-артефактов и бренд живут в `marketing/brand/` (это наша реализация). Здесь — внешняя теория и инструментарий, на которые она опирается.
