...
Ниже — 7 паттернов, извлечённых из arscontexta и применимых к проектированию скиллов. Ссылка из todo-skill.md, Шаг 3.
...
- ../../../lab/todo-skill.md — процесс создания скилла (ссылается на этот файл)
