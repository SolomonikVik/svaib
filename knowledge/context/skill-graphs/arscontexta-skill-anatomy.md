...
Ниже — 7 паттернов, извлечённых из arscontexta и применимых к проектированию скиллов. Используются на фазе дизайна нашего процесса создания скиллов.
...
**Применимость:** Для plugin клиентам Second Value AI Brain. Не для внутренних скиллов (у нас один домен).
...
- [../../skills/skill-activation.md](../../skills/skill-activation.md) — механика активации: почему progressive disclosure паттернов важен на практике
