...
Наш product/ontology — по сути context graph для CEO. Мы структурируем decision traces руководителя: встречи → протоколы → решения → задачи. Разница с Foundation Capital: они говорят про enterprise-масштаб, мы — про персональный Second Value AI Brain одного руководителя. Но принцип тот же: собирать reasoning, а не только результаты.
