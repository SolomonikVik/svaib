...
|---|---|---|---|
| **Knowledge Graph** | Граф (entity → relation → entity). Явные семантические связи | Фактические отношения, справочники, structured knowledge | MemLLM, AriGraph, G-Mem, LightRAG |
