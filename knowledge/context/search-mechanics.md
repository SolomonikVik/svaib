...
- Google Docs в Project Knowledge — **снимок** на момент загрузки, отстаёт на 2+ часа. Для актуальных данных — Google Workspace коннектор: Drive Fetch читает актуальную версию Google Doc по ID. Drive Search ищет файлы на Drive (один уровень вглубь). Подробнее → [../tools/claude-project.md](../tools/claude-project.md)

Источник: эксперименты Виктора Соломоника, февраль–март 2026.
