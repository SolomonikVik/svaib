...
**Пример:**
- Плохо: "Какие тренды в AI в 2025?"
  → AI может выдать устаревшее или придуманное
- Хорошо: "Какие тренды в AI в 2025? Сходи в интернет и проверь актуальные данные"
  → AI использует web-search, находит свежую информацию
...
**Версия:** 1.5 (обновлено 24 октября 2025)
**Последнее изменение:** Детализирована Часть 4 (Контекст) + добавлены эмодзи ● для всех пронумерованных блоков
