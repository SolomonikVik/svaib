...
### 🔸 3. ОБУЧЕНИЕ: Как модель учится предсказывать
...
**Версия:** 1.7 (обновлено 24 октября 2025)
**Последнее изменение:** Упрощена Часть 1 (блоки 3-6): убрана АРХИТЕКТУРА, упрощены описания ОБУЧЕНИЕ, ВЕСА, FINE-TUNING, INFERENCE
