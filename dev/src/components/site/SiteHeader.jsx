...
export default function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#071616]/90 text-white backdrop-blur">
      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <details className="details-reset relative md:hidden">
          ...
          <div className="absolute right-0 top-12 w-64 rounded-2xl border border-white/10 bg-[#102727] p-3 shadow-2xl">
