...
### Решение: VS Code + Claude Code

#### Редактор кода
- **VS Code** (Visual Studio Code) — бесплатный
- Терминал встроенный

#### AI-инструмент разработки
- **Claude Code** (CLI) — работает в терминале VS Code

#### Подписка
- **Claude Max:** $100/мес
- Причина: базовая $20 не хватала уже без кода
- Даёт: 5x больше лимитов, Sonnet 4.5 без ограничений

#### Workflow разработки
VS Code → Claude Code (в терминале) → Git → GitHub → Vercel → svaib.com
...
Все A-записи направлены на сервер **5.129.237.127**:
- `@` (svaib.com) → 5.129.237.127
- `www.svaib.com` → 5.129.237.127
