...
{1-2 предложения — главная тема недели}

### Лаборатория — Xч
{2-4 предложения макс}
...
### Маркетинг — Xч
{2-4 предложения макс, ОБЯЗАТЕЛЬНО указать кол-во постов}
...
**Стиль:**
- Нарративная проза, НЕ буллеты — связные предложения
- Макс 3-4 предложения на направление — это краткая выжимка, не эссе
- Пустые направления пропускать целиком — не включать секции без данных
- Тон из постов Виктора в Telegram: лёгкий, с самоиронией, честный
...
- [ ] Общий объём: компактно (100-300 слов)
