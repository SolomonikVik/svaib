...
2. Если worklog пуст — спроси Виктора о задаче. Если задача выглядит большой (>1 сессии) — предложи обсудить план и зафиксировать в worklog.
3. Определи роль (CTO / Developer), действуй.
