...
Канон scaffold — v4.1, но на старые пути (`01_ceo/`, `02_strategy/`, `04_company/`) продолжали ссылаться [methodology/onboarding.md](methodology/onboarding.md), [memory/update-protocol.md](methodology/memory/update-protocol.md) и [meeting_overlays.md](methodology/meeting_overlays.md) — обновление до них не дошло. Приведены к v4.1. `methodology.md` (v5, февраль) не тронут: там не пути, а модель v3 целиком — переработка в [03_backlog.md](03_backlog.md).
