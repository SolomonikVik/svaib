...
Не баг: документированное поведение Google Drive (orphaned-файл). Разбор и источники — meta/management/03_progress.md (запись 2026-07-21), знание — [knowledge/context/claude_integrations_gdrive.md](../knowledge/context/claude_integrations_gdrive.md). Ревью системы синхронизации Drive у клиентов остаётся открытым в 02_backlog.
