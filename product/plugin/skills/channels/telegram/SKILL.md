...
**Плоский или rich.** Структурный вывод (таблицы, ≥2 секции, дайджест) → rich-режим (см. [«Rich-режим»](#rich-режим-sendrichmessage-bot-api-101) ниже). Короткое сообщение в 2-3 строки → обычный режим.
